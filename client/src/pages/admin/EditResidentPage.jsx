/*
 * Project note: Edit Resident Page supports the admin and committee-user operation workflow.
        ...
        {!status.loading && !status.error ? (
          <form className="form" onSubmit={handleSubmit}>
            ...
            <div className="form-grid">
              ...
              <label>
                Zone / Area
                <input name="zone" type="text" value={formData.zone} onChange={handleChange} />
              </label>
            </div>
            <div className="form-grid">
              <label>
            ...
            <div className="button-row">
              ...
              <button type="button" className="button button-secondary" onClick={() => navigate("/admin/residents")} disabled={status.saving}>
                Back To Directory
              </button>
